##class Product:
##    def _init_(self, product_id, name, category, price, quantity, reorder_level):
...
##
##
### Inventory class (dictionary-based storage)
##class Inventory:
##    def _init_(self):
...
##            print(f"{product.product_id} | {product.name} | Qty: {product.quantity}")
##
##
### File manager class (saving/loading)
##class FileManager:
##    def save_inventory(self, inventory, filename):
##        import pickle
##        with open(filename, "wb") as f:
##            pickle.dump(inventory.products, f)
##
...
### Transaction logging
##class Transaction:
##    def _init_(self, transaction_id, product_id, quantity, transaction_type, date):
...
##
### Add products
##p1 = Product(1, "Laptop", "Electronics", 1200, 10, 3)
##p2 = Product(2, "Mouse", "Electronics", 25, 50, 10)
##
##inventory.add_product(p1)
##inventory.add_product(p2)
##
### Access products quickly using dictionary key
##print("Access product 1:", inventory.get_product(1).name)
##
### Update quantity
##inventory.get_product(1).update_quantity(-2)
##print("Updated quantity:", inventory.get_product(1).quantity)
##
### List all products
##inventory.list_products()
##
### Check low stock
##for prod in inventory.products.values():
##    if prod.is_low_stock():
##        print(f"Low stock alert for {prod.name}")# Product class
##        self.transactions.append(transaction)
